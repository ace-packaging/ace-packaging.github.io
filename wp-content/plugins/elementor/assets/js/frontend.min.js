...
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([
  [819, 637],
  {
        ...
        "Array",
        {
          from: function from(e) {
            var t,
              ...
              y = d(f);
            if (
              (p && (g = r(g, v > 2 ? arguments[2] : void 0, 2)),
              null == y || (h == Array && s(y)))
            )
              for (n = new h((t = l(f.length))); t > m; m++)
                u(n, m, p ? g(f[m], m) : f[m]);
            else
        ...
        S = (function (e) {
          ...
          function Frontend() {
            ...
            for (var n = arguments.length, r = new Array(n), i = 0; i < n; i++)
              r[i] = arguments[i];
            return (
              ((e = t.call.apply(t, [this].concat(r))).config =
            ...
            (0, s.default)(Frontend, [
              ...
              },
              {
                ...
                value: function getDeviceSetting(e, t, n) {
                  for (
                    var r = ["desktop", "tablet", "mobile"], i = r.indexOf(e);
                    i > 0;
              ...
              },
              {
                ...
                value: function addUserAgentClasses() {
                  for (
                    var e = 0, t = (0, o.default)(f.default);
                    e < t.length;
                    e++
                  ) {
              ...
              },
              {
                ...
                value: function populateActiveBreakpointsConfig() {
                  ...
                  (this.config.responsive.activeBreakpoints = {}),
                    (0, o.default)(this.config.responsive.breakpoints).forEach(
                      function (t) {
                        var n = (0, i.default)(t, 2),
                          r = n[0],
                          o = n[1];
                        o.is_enabled &&
                          (e.config.responsive.activeBreakpoints[r] = o);
                      }
                    );
                },
              },
      ...
      var o = r(n(9117)),
        ...
        f = (function (e) {
          ...
          function BackgroundSlideshow() {
            return (
              (0, a.default)(this, BackgroundSlideshow),
                    ...
                    n = {
                      ...
                      on: {
                        slideChange: function slideChange() {
                          t.background_slideshow_ken_burns &&
                            e.handleKenBurns();
                        },
                      },
                    };
                ...
                value: function buildSwiperElements() {
                  ...
                  (this.elements.$slides = jQuery()),
                    n.background_slideshow_gallery.forEach(function (n) {
                      ...
                      r.append(i),
                        o.append(r),
                        (e.elements.$slides = e.elements.$slides.add(r));
                    }),
                    i.append(o),
      ...
      var i = r(n(1959)),
        ...
        d = (function (e) {
          ...
          function GlobalHandler() {
            return (
              (0, i.default)(this, GlobalHandler), t.apply(this, arguments)
            );
          }
          return (
      ...
      var i = r(n(1959)),
        ...
        d = (function (e) {
          ...
          function BackgroundVideo() {
            return (
              (0, i.default)(this, BackgroundVideo), t.apply(this, arguments)
            );
          }
          return (
      ...
      var i = r(n(1959)),
        ...
        l = (function (e) {
          ...
          function HandlesPosition() {
            return (
              (0, i.default)(this, HandlesPosition), t.apply(this, arguments)
            );
          }
          return (
      ...
      var i = r(n(1959)),
        ...
        d = (function (e) {
          ...
          function StretchedSection() {
            return (
              (0, i.default)(this, StretchedSection), t.apply(this, arguments)
            );
          }
          return (
    ...
    6866: (e, t, n) => {
                  ...
                  return (
                    r.loader ||
                      (r.loader = new i.default(function (t) {
                        var i =
                          "style" === e
                            ? n.getStyleElement(r.src)
                            : n.getScriptElement(r.src);
                        i.onload = function () {
                          return t(!0);
                        };
      ...
      t.default = s;
      var l = elementorFrontendConfig.environmentMode.isScriptDebug
        ? ""
        : ".min";
      s.assets = {
        script: {
      ...
      var a = r(n(9117)),
        ...
        h = (function (e) {
          ...
          function LightboxManager() {
            return (
              (0, s.default)(this, LightboxManager), r.apply(this, arguments)
            );
          }
          return (
            (0, l.default)(
                ...
                },
                {
                  ...
                  value: function isLightboxLink(e) {
                    if (
                      ...
                      return !1;
                    var t = elementorFrontend.getKitSettings(
                              ...
                              switch ((o.prev = o.next)) {
                                case 0:
                                  if (
                                    ...
                                    (i = !!n.closest(".elementor-edit-area")
                                      .length),
                                ...
                                case 7:
                                  ...
                                  return (
                                    (o.next = 10), LightboxManager.getLightbox()
                                  );
                                case 10:
                ...
                value: function adjustConfig(e) {
                  ...
                  return (
                    (0, o.default)(e.breakpoints).forEach(function (r) {
                      var o,
                        a = (0, i.default)(r);
                      if (a === t.mobile.value || a + 1 === t.mobile.value)
                        o = 0;
                      else if (
                        !t.widescreen ||
                        (a !== t.widescreen.value &&
                          a + 1 !== t.widescreen.value)
                      ) {
          ...
          return (
            (0, l.default)(_default, [
              ...
              },
              {
                ...
                value: function onInit() {
                  (0, u.default)(
                    (0, d.default)(_default.prototype),
                    "onInit",
                    this
                  ).call(this),
                    this.initActions(),
      ...
      var i = r(n(1959)),
        ...
        l = (function (e) {
          ...
          function YoutubeLoader() {
            return (
              (0, i.default)(this, YoutubeLoader), t.apply(this, arguments)
            );
          }
          return (
        ...
        return [
          ...
          function (e) {
            ...
            for (var c, f = [], h = 0; null !== (c = a(l, u)); ) {
              var v = String(c[0]);
              (f[h] = v),
                "" === v && (l.lastIndex = o(u, i(l.lastIndex), d)),
                h++;
            }
            return 0 === h ? null : f;
          },
    ...
    6248: (e) => {
      var t = (function (e) {
            ...
            (o._invoke = (function makeInvokeMethod(e, t, n) {
              ...
              return function invoke(i, o) {
                ...
                for (n.method = i, n.arg = o; ; ) {
                  ...
                  "throw" === h.type &&
                    ((r = c), (n.method = "throw"), (n.arg = h.arg));
                }
              };
            })(e, n, a)),
            o
            ...
            if (!isNaN(e.length)) {
              var i = -1,
                a = function next() {
                  for (; ++i < e.length; )
                    if (r.call(e, i))
                      return (next.value = e[i]), (next.done = !1), next;
        ...
        return (
          (GeneratorFunction.prototype = p.constructor =
          ...
          (Context.prototype = {
            ...
            finish: function (e) {
              for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                ...
                if (n.finallyLoc === e)
                  return (
                    this.complete(n.completion, n.afterLoc), resetTryEntry(n), f
                  );
              }
            },
            catch: function (e) {
