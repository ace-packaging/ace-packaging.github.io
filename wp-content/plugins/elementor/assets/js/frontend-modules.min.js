        ...
        return (
          (t.exports = _wrapNativeSuper =
            function _wrapNativeSuper(t) {
              ...
              return (
                (Wrapper.prototype = n(t.prototype, {
                  constructor: {
                    value: Wrapper,
                    enumerable: !1,
                    writable: !0,
    ...
    1023: (t, e, r) => {
      ...
      t.exports = function (t) {
        var e = n(t),
          r = o.f;
        if (r)
          for (var s, u = r(t), a = i.f, c = 0; u.length > c; )
      ...
      t.exports = function (t, e, r, d, g, y, m) {
        ...
        if (
          (T &&
            ...
            _.next &&
            (c(_, b, !0),
            n || "function" == typeof _[f] || s(_, f, returnThis)),
          w &&
            I &&
            I.name !== h &&
            ((O = !0),
    ...
    5548: (t, e, r) => {
      ...
      t.exports = r(3752)
        ...
        : function defineProperties(t, e) {
            o(t);
            for (var r, s = i(e), u = s.length, a = 0; u > a; )
              n.f(t, (r = s[a++]), e[r]);
            return t;
          };
    },
          ...
          ("__proto__" in {}
            ? (function (t, e, n) {
                try {
                  (n = r(9365)(
                    Function.call,
                    r(3282).f(Object.prototype, "__proto__").set,
                    2
                  ))(t, []),
    ...
    5638: (t, e, r) => {
      ...
      var n = r(3227),
        ...
        K = function defineProperties(t, e) {
          m(t);
          for (var r, n = g((e = _(e))), o = 0, i = n.length; i > o; )
            J(t, (r = n[o++]), e[r]);
          return t;
        },
        Y = function propertyIsEnumerable(t) {
          ...
          return (
            !(this === q && o(H, t) && !o(W, t)) &&
            (!(e || !o(this, t) || !o(H, t) || (o(this, N) && this[N][t])) || e)
          );
        },
        X = function getOwnPropertyDescriptor(t, e) {
          if (((t = _(t)), (e = b(e, !0)), t !== q || !o(H, e) || o(W, e))) {
            var r = M(t, e);
            return (
              !r || !o(H, e) || (o(t, N) && t[N][e]) || (r.enumerable = !0), r
            );
          }
        },
        Z = function getOwnPropertyNames(t) {
          for (var e, r = A(_(t)), n = [], i = 0; r.length > i; )
            o(H, (e = r[i++])) || e == N || e == a || n.push(e);
          return n;
        },
        tt = function getOwnPropertySymbols(t) {
          for (
            var e, r = t === q, n = A(r ? W : _(t)), i = [], s = 0;
            n.length > s;

          )
            !o(H, (e = n[s++])) || (r && !o(q, e)) || i.push(H[e]);
          return i;
        };
      V ||
        (u(
              ...
              },
              {
                ...
                value: function onInit() {
                  ...
                  (this.$element = this.getSettings("$element")),
                    (0, s.default)(
                      (0, u.default)(_default.prototype),
                      "onInit",
                      this
                    ).call(this),
    ...
    5658: (t) => {
      ...
      t.exports = elementorModules.ViewModule.extend({
        ...
        stretch: function stretch() {
          ...
          var a = {};
          (a.width = n + "px"),
            (a[this.getSettings("direction")] = s + "px"),
            r.css(a);
        },
        reset: function reset() {
          var t = { width: "" };
          (t[this.getSettings("direction")] = ""),
            this.elements.$element.css(t);
        },
      });
    },
    2618: (t, e, r) => {
      ...
      var o = n(r(4596)),
        ...
        c = (function (t) {
          ...
          function ArgsObject(t) {
            var r;
            return (
              (0, i.default)(this, ArgsObject), ((r = e.call(this)).args = t), r
            );
          }
          return (
                ...
                value: function requireArgumentType(t, e) {
                  var r =
                    arguments.length > 2 && void 0 !== arguments[2]
                      ? arguments[2]
                      : this.args;
                  if ((this.requireArgument(t, r), (0, o.default)(r[t]) !== e))
                ...
                value: function requireArgumentInstance(t, e) {
                  var r =
                    arguments.length > 2 && void 0 !== arguments[2]
                      ? arguments[2]
                      : this.args;
                  if ((this.requireArgument(t, r), !(r[t] instanceof e)))
                ...
                value: function requireArgumentConstructor(t, e) {
                  var r =
                    arguments.length > 2 && void 0 !== arguments[2]
                      ? arguments[2]
                      : this.args;
                  if ((this.requireArgument(t, r), r[t].constructor !== e))
    ...
    869: (t, e, r) => {
      ...
      e.default = function _default() {
        var t = Error().stack.split("\n")[2].trim(),
          ...
          r = {};
        if (
          ((r.functionName = e), (r.fullName = e), r.functionName.includes("."))
        ) {
        ...
        l = (function () {
          function InstanceType() {
            ...
            for (
              ...
              r.push(e.__proto__), (e = e.__proto__);
                  ...
                  if (
                    ...
                    var r =
                      this.getInstanceType === InstanceType.getInstanceType
                        ? "BaseInstanceType"
                        : this.getInstanceType();
                    -1 === t.instanceTypes.indexOf(r) &&
                      t.instanceTypes.push(r);
                  }
                  return (
                    !e &&
                      t &&
      ...
      var s = function Module() {
        ...
        (this.getItems = function (t, e) {
          ...
          (this.setSettings = function (r, o, s) {
            if ((s || (s = t), "object" === (0, i.default)(r)))
              return e.extend(s, r), n;
            var u = r.split("."),
              a = u.splice(0, 1);
            return u.length
              ? (s[a] || (s[a] = {}), n.setSettings(u.join("."), o, s[a]))
              : ((s[a] = o), n);
          }),
          ...
          (e += (0, o.default)(this.elements.$container.css("margin-top"), 10)),
            this.elements.$items.each(function (i) {
              var s = Math.floor(i / n),
                u = jQuery(this),
                a =
                  u[0].getBoundingClientRect().height + r.verticalSpaceBetween;
              if (s) {
                var c = u.position(),
                  l = i % n,
                  f = c.top - e - t[l];
                (f -= (0, o.default)(u.css("margin-top"), 10)),
                  (f *= -1),
                  u.css("margin-top", f + "px"),
                  (t[l] += a);
              } else t.push(a);
            });
        },
    ...
    7738: (t, e, r) => {
      ...
      (r(66).inspectSource = function (t) {
        ...
        (t.exports = function (t, e, r, u) {
          ...
          a && (i(r, "name") || o(r, "name", e)),
            t[e] !== r &&
              (a && (i(r, s) || o(r, s, t[e] ? "" + t[e] : c.join(String(e)))),
              t === n
                ? (t[e] = r)
                : u
                ? t[e]
          ...
          [
            ...
            function (t, e) {
              ...
              for (var _ = 0, b = 0, w = []; b < p.length; ) {
                ...
                if (
                  null === E ||
                  (O = f(u(x.lastIndex + (h ? 0 : b)), p.length)) === _
                )
                  b = s(p, b, y);
                else {
